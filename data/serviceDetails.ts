...
export const serviceDetails: ServiceDetail[] = [
  // ─── AIR FREIGHT ─────────────────────────────────────────────────
  {
    ...
    serviceTypesIntro: 'Next Track Global Pet Transport offers a comprehensive range of air freight solutions designed to meet diverse shipping requirements:',
    serviceTypes: [
    ...
    processTitle: 'How Air Freight Works with Next Track Global Pet Transport',
  ...
  // ─── OCEAN FREIGHT ───────────────────────────────────────────────
  {
    ...
    overviewParagraphs: [
      ...
      'Next Track Global Pet Transport provides comprehensive ocean freight services — from full container loads (FCL) and less-than-container loads (LCL) to specialized reefer and open-top containers. We maintain strategic partnerships with leading ocean carriers to secure competitive rates and guaranteed space across all major trade lanes.',
    ...
    serviceTypesIntro: 'Next Track Global Pet Transport delivers end-to-end ocean freight solutions tailored to your specific trade requirements:',
    serviceTypes: [
    ...
    processTitle: 'How Ocean Freight Works with Next Track Global Pet Transport',
  ...
  // ─── LAND TRANSPORT ──────────────────────────────────────────────
  {
    ...
    overviewParagraphs: [
      ...
      'Next Track Global Pet Transport operates an extensive ground transportation network featuring GPS-tracked fleets, experienced drivers, and strategically positioned hubs. Our road and rail solutions seamlessly integrate with air and ocean freight to deliver true door-to-door coverage anywhere on the map.',
    ...
    serviceTypesIntro: 'Next Track Global Pet Transport provides a full spectrum of ground freight solutions for every requirement:',
    serviceTypes: [
    ...
    processTitle: 'How Land Transport Works with Next Track Global Pet Transport',
  ...
  // ─── EXPRESS COURIER ─────────────────────────────────────────────
  {
    ...
    serviceTypesIntro: 'Next Track Global Pet Transport offers tiered express services to match your urgency and budget:',
    serviceTypes: [
  ...
  // ─── WAREHOUSING & DISTRIBUTION ──────────────────────────────────
  {
    ...
    overviewParagraphs: [
      ...
      'Next Track Global Pet Transport operates a network of strategically located warehousing facilities across key logistics hubs worldwide. Our facilities are equipped with advanced WMS technology, climate-controlled zones, high-security systems, and scalable layouts designed to grow with your business.',
    ...
    whyChooseIntro: 'Outsourcing warehousing to Next Track Global Pet Transport unlocks significant operational and financial advantages:',
    benefits: [
    ...
    serviceTypesIntro: 'Next Track Global Pet Transport provides comprehensive warehousing and distribution solutions:',
    serviceTypes: [
    ...
    processTitle: 'How Warehousing Works with Next Track Global Pet Transport',
    ...
    ctaDescription: 'Let Next Track Global Pet Transport design a warehousing and distribution strategy that reduces costs, improves speed, and scales with your business.',
    galleryImages: [
  ...
  // ─── SPECIALIZED CARGO ───────────────────────────────────────────
  {
    ...
    serviceTypesIntro: 'Next Track Global Pet Transport offers expert handling across a wide range of specialized cargo categories:',
    serviceTypes: [
  ...
  // ─── ANIMAL DELIVERY ──────────────────────────────────────────────
  {
    ...
    overviewParagraphs: [
      ...
      'At Next Track Global Pet Transport, our Animal Transport Division is staffed by certified animal handlers, veterinary consultants, and logistics specialists who understand that your animals are not cargo — they are family. We design bespoke transport plans that prioritize animal welfare above all else, ensuring comfortable temperatures, proper ventilation, adequate hydration, and minimal stress from origin to destination.',
      'Whether you\'re relocating internationally with your dog, shipping breeding livestock across state lines, transporting exotic reptiles for a zoological program, or moving laboratory animals under strict protocol, Next Track Global Pet Transport provides end-to-end solutions that comply with IATA Live Animals Regulations (LAR), USDA-APHIS requirements, CITES conventions, and all local animal welfare laws.',
    ],
    whyChooseTitle: 'Why Choose Professional Animal Transport?',
    whyChooseIntro: 'Transporting live animals requires expertise, certified equipment, and unwavering commitment to animal welfare. Here\'s why Next Track Global Pet Transport stands apart:',
    benefits: [
    ...
    serviceTypesIntro: 'Next Track Global Pet Transport offers comprehensive animal transport solutions tailored to every species, size, and destination:',
    serviceTypes: [
    ...
    processTitle: 'How Animal Transport Works with Next Track Global Pet Transport',
