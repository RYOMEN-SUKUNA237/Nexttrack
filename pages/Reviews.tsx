...
const allReviews = [
  { name: 'Sarah Mitchell', role: 'VP Supply Chain, TechFlow Inc.', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?fm=jpg&fit=crop&w=100&q=80', text: 'Next Track transformed our supply chain. Real-time tracking and proactive communication reduced our delivery issues by over 60%.', rating: 5, date: 'March 12, 2025' },
  { name: 'James Okonkwo', role: 'CEO, AfriTrade Exports', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?fm=jpg&fit=crop&w=100&q=80', text: 'From customs clearance to last-mile delivery, Next Track handles everything seamlessly. Our logistics backbone for 5 years.', rating: 5, date: 'February 28, 2025' },
  ...
  { name: 'Priya Sharma', role: 'E-Commerce Director, IndiaShop', avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?fm=jpg&fit=crop&w=100&q=80', text: 'We process 10,000 orders daily through Next Track warehousing. Their pick-and-pack accuracy is incredible — 99.7%.', rating: 5, date: 'April 10, 2025' },
  ...
  { name: 'Grace Ampah', role: 'CEO, GhanaExport Ltd', avatar: 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?fm=jpg&fit=crop&w=100&q=80', text: 'Next Track opened African market access for our cocoa exports. Their knowledge of African ports is unmatched.', rating: 5, date: 'March 8, 2025' },
  ...
  { name: 'Lorenzo Ferrari', role: 'CEO, AutoLux Italia', avatar: 'https://images.unsplash.com/photo-1507591064344-4c6ce005b128?fm=jpg&fit=crop&w=100&q=80', text: 'Transporting luxury vehicles requires extreme care. Next Track\'s enclosed transport kept every car pristine.', rating: 5, date: 'January 20, 2025' },
  ...
  { name: 'Mei Liang', role: 'Procurement Director, ShanghaiMed', avatar: 'https://images.unsplash.com/photo-1520813792240-56fc4a3765a7?fm=jpg&fit=crop&w=100&q=80', text: 'Medical device imports cleared customs 40% faster after Next Track took over our brokerage. Saving time and money.', rating: 4, date: 'April 8, 2025' },
  { name: 'Patrick O\'Brien', role: 'VP Logistics, IrishBrews', avatar: 'https://images.unsplash.com/photo-1500048993953-d23a436266cf?fm=jpg&fit=crop&w=100&q=80', text: 'Our craft beer reaches 45 countries now thanks to Next Track\'s beverage-specialized handling. Sales up 120%.', rating: 5, date: 'January 30, 2025' },
  { name: 'Zara Abdullah', role: 'Owner, DubaiLux Jewels', avatar: 'https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?fm=jpg&fit=crop&w=100&q=80', text: 'Shipping diamonds and precious metals requires ultimate trust. Next Track\'s high-value protocols are second to none.', rating: 5, date: 'February 18, 2025' },
  ...
  { name: 'Sandra Owusu', role: 'COO, AfricaFash', avatar: 'https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?fm=jpg&fit=crop&w=100&q=80', text: 'Pan-African distribution of our textile brand set up in 3 weeks by Next Track. Distribution network is phenomenal.', rating: 5, date: 'April 20, 2025' },
  ...
  { name: 'Henry Boateng', role: 'CEO, AccraTrade Hub', avatar: 'https://images.unsplash.com/photo-1474176857210-7287d4de6f5a?fm=jpg&fit=crop&w=100&q=80', text: 'Next Track helped us break into European export markets. Their documentation support made the process seamless.', rating: 5, date: 'March 15, 2025' },
  ...
  { name: 'Emma Johansson', role: 'Sustainability Lead, EcoShip AB', avatar: 'https://images.unsplash.com/photo-1554151228-14d9def656e4?fm=jpg&fit=crop&w=100&q=80', text: 'Next Track offers carbon-offset shipping options that align with our ESG goals. A logistics partner with a conscience.', rating: 5, date: 'April 18, 2025' },
];
          ...
          <form onSubmit={handleSubmit} className="bg-[#f8f9fb] rounded-xl border border-gray-200 p-6 sm:p-8 space-y-5 shadow-sm">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Tell us about your experience with Next Track Global Pet Transport..."
